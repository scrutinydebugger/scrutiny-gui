...
import { TileTypeIndex, defineNewTileManagerRenderer } from '@scrutiny/ui/TileManager';
...
// the widget content
const availableTileTypes = widgets.reduce((tileTypes: TileTypeIndex, widgetModule: WidgetModule) => {
    const widgetType = widgetModule.definition.name;
